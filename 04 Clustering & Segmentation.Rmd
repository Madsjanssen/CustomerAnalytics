...
apply(HBAT[, hbat], 2, sd)  # Calculate and display the standard deviation for each variable
...
MD.km28 <- relabel(MD.km28) # Not working
...
# Create a barchart to visualize the segment profile using the cluster order from hierarchical clustering. 'which' parameter uses the order of the hierarchical clusters to arrange the segments.
...
The first (MD.m4a) is apparently based on the k-means model.
The second (MD.m4) is also a mix-model.
