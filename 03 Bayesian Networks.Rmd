...
products = read.csv("../Code/Data/CollFilforR.csv", header = T, colClasses = "factor", sep = ";")
View(products)
```
...
products_dag = tree.bayes(products_wNA, "class") 
...
graph.model <- as.graphNEL(products_dag)
gr.model <- grain(graph.model, data =  products_wNA, smooth = 1)
