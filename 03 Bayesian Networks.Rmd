...
dag1 <- set.arc (dag, from = "Fuse", to = "Atti")
dag1 <- set.arc (dag, from = "Plea", to = "Atti")
dag1 <- set.arc (dag, from = "Fuse", to = "Comm")
dag1 <- set.arc (dag, from = "Plea", to = "Comm")
dag1 <- set.arc (dag, from = "Atti", to = "Comm")
